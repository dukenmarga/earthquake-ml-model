...
if __name__ == "__main__":
    ...
    # mass is based on:
    area = [30, 50, 60, 80, 110]  # [m2]
    mass_per_area = [24, 32, 43]  # [kg/m2]
    masses: list[float] = []
    masses = [a * w for a in area for w in mass_per_area]

    # stiffness is based on the structural properties: n * 12EI/l^3, I = bh^3/12, L=4m
    ks = [
        6 * 12 * 20000 * 0.2 * 0.3**3 / 12 / (4**3) * 1000,
        6 * 12 * 20000 * 0.25 * 0.25**3 / 12 / (4**3) * 1000,
        8 * 12 * 20000 * 0.3 * 0.3**3 / 12 / (3.5**3) * 1000,
        6 * 12 * 20000 * 0.2 * 0.2**3 / 12 / (3**3) * 1000,
        6 * 12 * 20000 * 0.25 * 0.25**3 / 12 / (3.5**3) * 1000,
        8 * 12 * 20000 * 0.4 * 0.4**3 / 12 / (4**3) * 1000,
    ]  # stiffness in KN/m
    dampings = [
        0.02,
        0.03,
    ...
    sac_files = glob.glob("acc-testing/*.sac")
